...
export const POIS = [
  ...
  },
  {
    ...
    elevation: '1923 m', elevationGain: '+510 m', recommendedDay: 17,
  ...
  },
  {
    ...
    elevation: '2137 m', elevationGain: '+220 m', recommendedDay: 18,
  ...
  return [
    ...
    },
    {
      ...
      events: [
        ...
        { time: '14:30', icon: '🏞️', text: 'Lago di Braies – turkio spalvos ežeras ir apžvalginis žygis' },
        { time: '20:00', icon: '🍝', text: 'Vakarienė vietiniame restorane' },
      ],
      poi: POIS.find((p) => p.id === 'braies'),
      parking: POIS.find((p) => p.id === 'braies').parking,
      overnight: town,
    },
    {
      day: 16,
    ...
    },
    {
      ...
      title: '🎂 Gimtadienis #2 – Lago di Sorapis',
      type: 'birthday',
      birthdayNumber: 2,
      events: [
        { time: '09:00', icon: '🌄', text: 'Pusryčiai Pieve di Cadore, išsiregistravimas' },
        { time: '10:30', icon: '🥐', text: `Brunch: Bar Pasticceria Fiori (${selectedTown === 'sanvito' ? '2 min.' : 'San Vito di Cadore'}) – šventinis brunch'as` },
        { time: '12:00', icon: '🚗', text: 'Išvykimas link Passo Tre Croci (Sorapis žygio pradžia)' },
        { time: '12:30–16:30', icon: '🥾', text: 'Vidutinio sunkumo žygis į Lago di Sorapis (11 km, 3–4 val.) – aktyvus Gimtadienis #2!' },
        { time: '17:30', icon: '🏨', text: 'Atvykimas į Borca di Cadore (Nakvynė)' },
      ],
    ...
    },
    {
      ...
      type: 'departure',
      events: [
        { time: '08:30', icon: '🌄', text: 'Pusryčiai Borca di Cadore, išsiregistravimas' },
        { time: '09:15', icon: '🚗', text: 'Išvykimas link Bai de Dones keltuvo (Cinque Torri)' },
        { time: '10:00–12:00', icon: '🥾', text: 'Cinque Torri – lengvas atsisveikinimo pasivaikščiojimas (4 km, 2 val.)' },
        { time: '12:00', icon: '🥂', text: 'Pakilimas keltuvu ir Prosecco taurė Rifugio Scoiattoli terasoje prieš kelionę į oro uostą' },
        { time: '13:30', icon: '🚗', text: 'Išvykimas link Trevizo / Venecijos' },
